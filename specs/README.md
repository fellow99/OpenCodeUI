...
> 本目录包含 OpenCodeUI 项目的完整规范文档体系，涵盖项目级架构文档、16 个功能模块的详细规范，以及 1 个扩展功能规范。
...
| 901 | 服务快捷面板   | [spec](./901-ext-server-quick-panel/spec.md) | [plan](./901-ext-server-quick-panel/plan.md) | 跨服务器浏览和切换会话的浮动面板                 |
...
_生成时间: 2026-04-12 | 最后更新: 2026-04-13_
